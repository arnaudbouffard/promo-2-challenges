...
# - Just look in the doc for the right method
# of the String, Fixnum, and Array classes !
...
def exactly_divide(an_integer, a_divider)
  # TODO: return divison of an_integer by a_divider
  #(computing the floating division, NOT the euclidean one)
